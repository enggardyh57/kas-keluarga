...
(self.webpackChunk = self.webpackChunk || []).push([
	[311], {
		762(t, e, i) {
			...
			function m(t) {
				if (r(t)) return t.map(m);
				if (l(t)) {
					const e = Object.create(null),
						i = Object.keys(t),
						s = i.length;
					let n = 0;
					for (; n < s; ++n) e[i[n]] = m(t[i[n]]);
					return e
				}
				return t
			}
			...
			function v(t, e, i) {
				...
				const s = e[t],
					n = i[t];
				l(s) && l(n) ? y(s, n) : Object.prototype.hasOwnProperty.call(e, t) || (e[t] = m(n))
			}
			const M = {
				"": t => t,
				x: t => t.x,
			...
			const Z = (t, e, i, s) => Q(t, i, s ? s => {
					const n = t[s][e];
					return n < i || n === i && t[s + 1][e] === i
				} : s => t[s][e] < i),
				tt = (t, e, i) => Q(t, i, s => t[s][e] >= i);
			...
			const nt = "undefined" == typeof window ? function (t) {
				return t()
			...
			function ot(t, e) {
				let i = [],
					s = !1;
				return function (...n) {
					i = n, s || (s = !0, nt.call(window, () => {
						s = !1, t.apply(e, i)
					}))
				}
			}
			const at = t => "start" === t ? "left" : "end" === t ? "right" : "center",
				rt = (t, e, i) => "start" === t ? e : "end" === t ? i : (e + i) / 2;
			...
			function lt(t, e, i) {
				...
				if (t._sorted) {
					...
					if (g) {
						if (n = Math.min(Z(h, d, u).lo, i ? s : Z(e, d, r.getPixelForValue(u)).lo), c) {
							const t = h.slice(0, n + 1).reverse().findIndex(t => !a(t[l.axis]));
							n -= Math.max(0, t)
						}
						n = G(n, 0, s - 1)
					}
					if (p) {
						let t = Math.max(Z(h, r.axis, f, !0).hi + 1, i ? 0 : Z(e, d, r.getPixelForValue(f), !0).hi + 1);
						if (c) {
							const e = h.slice(t - 1).findIndex(t => !a(t[l.axis]));
							t += Math.max(0, e)
						}
						o = G(t, n, s) - n
					} else o = s - n
			...
			const ct = t => 0 === t || 1 === t,
				dt = (t, e, i) => -Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * O / i),
				ut = (t, e, i) => Math.pow(2, -10 * t) * Math.sin((t - e) * O / i) + 1,
				ft = {
					linear: t => t,
					easeInQuad: t => t * t,
					easeOutQuad: t => -t * (t - 2),
					...
					easeInElastic: t => ct(t) ? t : dt(t, .075, .3),
					easeOutElastic: t => ct(t) ? t : ut(t, .075, .3),
					easeInOutElastic(t) {
						const e = .1125;
						return ct(t) ? t : t < .5 ? .5 * dt(2 * t, e, .45) : .5 + .5 * ut(2 * t - 1, e, .45)
					},
					easeInBack(t) {
						const e = 1.70158;
						return t * t * ((e + 1) * t - e)
					...
					easeInBounce: t => 1 - ft.easeOutBounce(1 - t),
					easeOutBounce(t) {
						const e = 7.5625,
							i = 2.75;
						return t < 1 / i ? e * t * t : t < 2 / i ? e * (t -= 1.5 / i) * t + .75 : t < 2.5 / i ? e * (t -= 2.25 / i) * t + .9375 : e * (t -= 2.625 / i) * t + .984375
					},
					easeInOutBounce: t => t < .5 ? .5 * ft.easeInBounce(2 * t) : .5 * ft.easeOutBounce(2 * t - 1) + .5
				};
			...
			function pt(t) {
				return gt(t) ? t : new s.Q1(t)
			}

			function mt(t) {
				return gt(t) ? t : new s.Q1(t).saturate(.5).darken(.1).hexString()
			}
			...
			function yt(t, e, i) {
				return function (t, e) {
					...
					let s = _t.get(i);
					return s || (s = new Intl.NumberFormat(t, e), _t.set(i, s)), s
				}(e, i).format(t)
			}
			const vt = {
				values: t => r(t) ? t : "" + t,
				numeric(t, e, i) {
					...
					return Object.assign(l, this.options.ticks.format), yt(t, s, l)
				},
				logarithmic(t, e, i) {
					if (0 === t) return "0";
					const s = i[e].significand || t / Math.pow(10, Math.floor(z(t)));
					return [1, 2, 3, 5, 10, 15].includes(s) || e > .8 * i.length ? vt.numeric.call(this, t, e, i) : ""
				}
			};
			var Mt = {
				formatters: vt
			...
			function Pt(t, e, i) {
				return "string" == typeof e ? _(St(t, e), i) : _(St(t, ""), e)
			}
			class Dt {
				constructor(t, e) {
					this.animation = void 0, this.backgroundColor = "rgba(0,0,0,0.1)", this.borderColor = "rgba(0,0,0,0.1)", this.color = "#666", this.datasets = {}, this.devicePixelRatio = t => t.chart.platform.getDevicePixelRatio(), this.elements = {}, this.events = ["mousemove", "mouseout", "click", "touchstart", "touchmove"], this.font = {
						...
						lineHeight: 1.2,
						weight: null
					}, this.hover = {}, this.hoverBackgroundColor = (t, e) => mt(e.backgroundColor), this.hoverBorderColor = (t, e) => mt(e.borderColor), this.hoverColor = (t, e) => mt(e.color), this.indexAxis = "x", this.interaction = {
						mode: "nearest",
						intersect: !0,
						includeInvisible: !1
			...
			function At(t, e, i, s) {
				...
				for (h = 0; h < l; h++)
					if (u = i[h], null == u || r(u)) {
						if (r(u))
							for (c = 0, d = u.length; c < d; c++) f = u[c], null == f || r(f) || (a = Ot(t, n, o, a, f))
					} else a = Ot(t, n, o, a, u);
				t.restore();
				const g = o.length / 2;
				if (g > i.length) {
			...
			function Ht(t, e, i, s, n, o = {}) {
				const l = r(e) ? e : [e],
					h = o.strokeWidth > 0 && "" !== o.strokeColor;
				let c, d;
				for (t.save(), t.font = n.string, function (t, e) {
						e.translation && t.translate(e.translation[0], e.translation[1]), a(e.rotation) || t.rotate(e.rotation), e.color && (t.fillStyle = e.color), e.textAlign && (t.textAlign = e.textAlign), e.textBaseline && (t.textBaseline = e.textBaseline)
					}(t, o), c = 0; c < l.length; ++c) d = l[c], o.backdrop && Nt(t, o.backdrop), h && (o.strokeColor && (t.strokeStyle = o.strokeColor), a(o.strokeWidth) || (t.lineWidth = o.strokeWidth), t.strokeText(d, i, s, o.maxWidth)), t.fillText(d, i, s, o.maxWidth), Wt(t, i, s, d, o), s += Number(n.lineHeight);
				t.restore()
			}
			...
			const $t = /^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/,
				Ut = /^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/;
			...
			function qt(t, e) {
				const i = {},
					s = l(e),
					n = s ? Object.keys(e) : e,
					o = l(t) ? s ? i => d(t[i], t[e[i]]) : e => t[e] : () => t;
				for (const t of n) i[t] = Xt(o(t));
				return i
			}
			...
			function Gt(t) {
				return qt(t, ["topLeft", "topRight", "bottomLeft", "bottomRight"])
			}
			...
			function Qt(t, e) {
				...
				s && !("" + s).match(Ut) && (s = void 0);
				const n = {
					family: d(t.family, e.family),
					lineHeight: Yt(d(t.lineHeight, e.lineHeight), i),
					size: i,
					style: s,
			...
			function Zt(t, e, i, s) {
				...
				for (n = 0, o = t.length; n < o; ++n)
					if (a = t[n], void 0 !== a && (void 0 !== e && "function" == typeof a && (a = a(e), l = !1), void 0 !== i && r(a) && (a = a[i % a.length], l = !1), void 0 !== a)) return s && !l && (s.cacheable = !1), a
			}
			...
			function ee(t, e = [""], i, s, n = () => t[0]) {
				...
				return new Proxy(a, {
					...
					get: (i, s) => ae(i, s, () => function (t, e, i, s) {
						let n;
						for (const o of e)
							if (n = ue(ne(o, t), i), void 0 !== n) return oe(t, n) ? ce(i, s, t, n) : n
					}(s, e, t, i)),
			...
			function ie(t, e, i, s) {
				...
				return new Proxy(n, {
					...
					get: (t, e, i) => ae(t, e, () => function (t, e, i) {
						const {
							_proxy: s,
							_context: n,
							_subProxy: o,
						...
						let h = s[e];
						P(h) && a.isScriptable(e) && (h = function (t, e, i, s) {
							const {
								_proxy: n,
								_context: o,
								_subProxy: a,
							...
							r.add(t);
							let l = e(o, a || s);
							r.delete(t), oe(t, l) && (l = ce(n._scopes, n, t, l));
							return l
						}(e, h, t, i));
						r(h) && h.length && (h = function (t, e, i, s) {
							const {
								_proxy: n,
								_context: o,
								_subProxy: a,
			...
			function se(t, e = {
				...
				return {
					...
					scriptable: i,
					indexable: s,
					isScriptable: P(i) ? i : () => i,
					isIndexable: P(s) ? s : () => s
				}
			}
			const ne = (t, e) => t ? t + k(e) : e,
				oe = (t, e) => l(e) && "adapters" !== t && (null === Object.getPrototypeOf(e) || e.constructor === Object);
			...
			const le = (t, e) => !0 === t ? e : "string" == typeof t ? w(e, t) : void 0;
			...
			function ce(t, e, i, s) {
				const n = e._rootScopes,
					o = re(e._fallback, i, s),
					a = [...t, ...n],
					h = new Set;
				h.add(s);
				let c = de(h, a, i, o || i, s);
				return null !== c && ((void 0 === o || o === i || (c = de(h, a, o, c, s), null !== c)) && ee(Array.from(h), [""], n, o, () => function (t, e, i) {
			...
			const pe = Number.EPSILON || 1e-14,
				me = (t, e) => e < t.length && !t[e].skip && t[e],
				xe = t => "x" === t ? "y" : "x";
			...
			function _e(t, e = "x") {
				...
				function (t, e, i) {
					const s = t.length;
					let n, o, a, r, l, h = me(t, 0);
					for (let c = 0; c < s - 1; ++c) l = h, h = me(t, c + 1), l && h && (V(e[c], 0, pe) ? i[c] = i[c + 1] = 0 : (n = i[c] / e[c], o = i[c + 1] / e[c], r = Math.pow(n, 2) + Math.pow(o, 2), r <= 9 || (a = 3 / Math.sqrt(r), i[c] = n * a * e[c], i[c + 1] = o * a * e[c])))
				}(t, n, o),
				function (t, e, i = "x") {
					const s = xe(i),
						n = t.length;
					let o, a, r, l = me(t, 0);
					for (let h = 0; h < n; ++h) {
						if (a = r, r = l, l = me(t, h + 1), !r) continue;
						const n = r[i],
							c = r[s];
			...
			function ve(t, e, i, s, n) {
				let o, a, r, l;
				if (e.spanGaps && (t = t.filter(t => !t.skip)), "monotone" === e.cubicInterpolationMode) _e(t, n);
				else {
					let i = s ? t[t.length - 1] : t[0];
					for (o = 0, a = t.length; o < a; ++o) r = t[o], l = be(i, r, t[Math.min(o + 1, a - (s ? 0 : 1)) % a], e.tension), r.cp1x = l.previous.x, r.cp1y = l.previous.y, r.cp2x = l.next.x, r.cp2y = l.next.y, i = r
				}
				e.capBezierPoints && function (t, e) {
					let i, s, n, o, a, r = It(t[0], e);
					for (i = 0, s = t.length; i < s; ++i) a = o, o = r, r = i < s - 1 && It(t[i + 1], e), o && (n = t[i], a && (n.cp1x = ye(n.cp1x, e.left, e.right), n.cp1y = ye(n.cp1y, e.top, e.bottom)), r && (n.cp2x = ye(n.cp2x, e.left, e.right), n.cp2y = ye(n.cp2y, e.top, e.bottom)))
				}(t, i)
			}
			...
			const Se = t => t.ownerDocument.defaultView.getComputedStyle(t, null);
			...
			function Ce(t, e) {
				...
				} = e, n = Se(i), o = "border-box" === n.boxSizing, a = De(n, "padding"), r = De(n, "border", "width"), {
					x: l,
					y: h,
					box: c
				} = function (t, e) {
			...
			function Ae(t, e, i, s) {
				const n = Se(t),
					o = De(n, "margin"),
					a = ke(n.maxWidth, t, "clientWidth") || T,
					r = ke(n.maxHeight, t, "clientHeight") || T,
					l = function (t, e, i) {
						let s, n;
				...
				h = Math.max(0, h - o.width), c = Math.max(0, s ? h / s : c - o.height), h = Oe(Math.min(h, a, l.maxWidth)), c = Oe(Math.min(c, r, l.maxHeight)), h && !c && (c = Oe(h / 2));
				return (void 0 !== e || void 0 !== i) && s && l.height && c > l.height && (c = l.height, h = Oe(Math.floor(c * s))), {
					width: h,
					height: c
				}
			}
			...
			function Te(t, e, i) {
				const s = e || 1,
					n = Oe(t.height * s),
					o = Oe(t.width * s);
				t.height = Oe(t.height), t.width = Oe(t.width);
				const a = t.canvas;
			...
			const Le = function () {
				...
				try {
					...
					Me() && (window.addEventListener("test", null, e), window.removeEventListener("test", null, e))
				} catch (t) {}
				return t
			}();
			...
			function He(t, e, i) {
				...
				const y = () => b || l(n, x, p) && 0 !== r(n, x),
					v = () => !b || 0 === r(o, p) || l(o, x, p);
				for (let t = c, i = c; t <= d; ++t) m = e[t % a], m.skip || (p = h(m[s]), p !== x && (b = l(p, n, o), null === _ && y() && (_ = 0 === r(p, n) ? t : i), null !== _ && v() && (g.push(Ne({
					start: _,
					end: t,
					loop: u,
					count: a,
					...
					for (const t of e) {
						...
						for (u = d + 1; u <= t.end; u++) {
							...
							e = Ue(s.setContext(te(n, {
								...
								p1DataIndex: u % l,
								datasetIndex: a
							}))), Ye(e, c) && f(d, u - 1, t.loop, c), o = r, c = e
						}
			...
			class Ke {
				...
				_refresh() {
					this._request || (this._running = !0, this._request = nt.call(window, () => {
			...
			class Ze {
				constructor(t, e, i, s) {
					const n = e[i];
					s = Zt([t.to, s, n, t.from]);
					const o = Zt([t.from, n, s]);
					this._active = !0, this._fn = t.fn || Qe[t.type || typeof o], this._easing = ft[t.easing] || ft.linear, this._start = Math.floor(Date.now() + (t.delay || 0)), this._duration = this._total = Math.floor(t.duration), this._loop = !!t.loop, this._target = e, this._prop = i, this._from = o, this._to = s, this._promises = void 0
				}
				active() {
					return this._active
				}
				update(t, e, i) {
					if (this._active) {
						...
						const s = this._target[this._prop],
							n = i - this._start,
							o = this._duration - n;
						this._start = i, this._duration = Math.floor(Math.max(o, t.duration)), this._total += n, this._loop = !!t.loop, this._to = Zt([t.to, e, s, t.from]), this._from = Zt([t.from, s, e])
					}
				}
				cancel() {
			...
			class ti {
				...
				configure(t) {
					...
					Object.getOwnPropertyNames(t).forEach(s => {
						...
						(r(n.properties) && n.properties || [s]).forEach(t => {
				...
				_createAnimations(t, e) {
					...
					for (r = o.length - 1; r >= 0; --r) {
						...
						d && d.duration ? (n[l] = c = new Ze(d, t, l, h), s.push(c)) : t[l] = h
					}
					return s
				}
				update(t, e) {
			...
			function si(t, e, i, s = {}) {
				...
				for (a = 0, r = n.length; a < r; ++a) {
					...
					c = t.values[l], h(c) && (o || 0 === e || F(e) === F(c)) && (e += c)
				}
				return d || s.all ? e : 0
			}
			...
			function ri(t, e) {
				...
				for (let t = 0; t < d; ++t) {
					...
					u = (i._stacks || (i._stacks = {}))[h] = oi(n, c, o), u[r] = d, u._top = ai(u, a, !0, s.type), u._bottom = ai(u, a, !1, s.type);
			...
			class ui {
				...
				initialize() {
					...
					this.configure(), this.linkScales(), t._stacked = ni(t.vScale, t), this.addElements(), this.options.fill && this.chart.isPluginEnabled("filler")
				}
				updateIndex(t) {
				...
				linkScales() {
					const t = this.chart,
						...
						n = e.xAxisID = d(i.xAxisID, li(t, "x")),
						o = e.yAxisID = d(i.yAxisID, li(t, "y")),
						a = e.rAxisID = d(i.rAxisID, li(t, "r")),
						r = e.indexAxis,
				...
				_destroy() {
					const t = this._cachedMeta;
					this._data && it(this._data, this), t._stacked && hi(t)
				}
				_dataCheck() {
				...
				buildOrUpdateElements(t) {
					...
					this._dataCheck();
					const n = e._stacked;
					e._stacked = ni(e.vScale, e), e.stack !== i.stack && (s = !0, hi(e), e.stack = i.stack), this._resyncElements(t), (s || n !== e._stacked) && (ri(this, e._parsed), e._stacked = ni(e.vScale, e))
				}
				configure() {
				...
				parse(t, e) {
					...
					if (!1 === this._parsing) i._parsed = s, i._sorted = !0, d = s;
						...
						d = r(s[t]) ? this.parseArrayData(i, s, t, e) : l(s[t]) ? this.parseObjectData(i, s, t, e) : this.parsePrimitiveData(i, s, t, e);
				...
				getAllParsedValues(t) {
					const e = this._cachedMeta._parsed,
						i = [];
					let s, n, o;
					for (s = 0, n = e.length; s < n; ++s) o = e[s][t.axis], h(o) && i.push(o);
					return i
				}
				getMaxOverflow() {
					return !1
				...
				_update(t) {
					...
					this.update(t || "default"), e._clip = function (t) {
						let e, i, s, n;
						return l(t) ? (e = t.top, i = t.right, s = t.bottom, n = t.left) : e = i = s = n = t, {
							top: e,
							right: i,
							bottom: s,
							left: n,
				...
				_resolveElementOptions(t, e = "default", i) {
					const s = "active" === e,
						...
						o = t + "-" + e,
						a = n[o],
						r = this.enableOptionSharing && S(i);
					if (a) return di(a, r);
					...
					return f.$shared && (f.$shared = r, n[o] = Object.freeze(di(f, r))), f
				}
				_resolveAnimations(t, e, i) {
					...
					const l = new ti(s, r && r.animations);
				...
				const e = t.iScale,
					i = function (t, e) {
						if (!t._cache.$bar) {
							...
							t._cache.$bar = st(s.sort((t, e) => t - e))
						}
						return t._cache.$bar
					}(e, t.type);
				let s, n, o, a, r = e._length;
				const l = () => {
					32767 !== o && -32768 !== o && (S(a) && (r = Math.min(r, Math.abs(o - a) || r)), a = o)
				};
			...
			function pi(t, e, i, s) {
				const n = t.iScale,
					...
					l = [];
				let h, c, d, u;
				for (h = i, c = i + s; h < c; ++h) u = e[h], d = {}, d[n.axis] = r || n.parse(a[h], h), l.push(gi(u, d, o, h));
				return l
			}
			...
			function xi(t, e, i, s) {
				...
				"middle" === n && i && (t.enableBorderRadius = !0, (i._top || 0) === s ? n = h : (i._bottom || 0) === s ? n = c : (o[bi(c, a, r, l)] = !0, n = h)), o[bi(n, a, r, l)] = !0, t.borderSkipped = o
			}

			function bi(t, e, i, s) {
				var n, o, a;
				return s ? (a = i, t = _i(t = (n = t) === (o = e) ? a : n === a ? o : n, i, e)) : t = _i(t, e, i), t
			}
			...
			class vi extends ui {
				...
				update(t) {
					...
					this.offsetX = m * v, this.offsetY = x * v, s.total = this.calculateTotal(), this.outerRadius = v - M * this._getRingWeightOffset(this.index), this.innerRadius = Math.max(this.outerRadius - M * c, 0), this.updateElements(n, 0, n.length, t)
				}
				_circumference(t, e) {
				...
				getLabelAndValue(t) {
					const e = this._cachedMeta,
						i = this.chart,
						s = i.data.labels || [],
						n = yt(e._parsed[t], i.options.locale);
					return {
						label: s[t] || "",
						value: n
					}
			...
			class Mi extends ui {
				...
				getLabelAndValue(t) {
					const e = this._cachedMeta,
						i = this.chart,
						s = i.data.labels || [],
						n = yt(e._parsed[t].r, i.options.locale);
					return {
						label: s[t] || "",
						value: n
					}
			...
			var wi = Object.freeze({
				...
				BarController: class extends ui {
					...
					parseObjectData(t, e, i, s) {
						...
						let d, u, f, g;
						for (d = i, u = i + s; d < u; ++d) g = e[d], f = {}, f[n.axis] = n.parse(w(g, l), d), c.push(gi(w(g, h), f, o, d));
						return c
					}
					updateRangeFromParsed(t, e, i, s) {
					...
					getLabelAndValue(t) {
						const e = this._cachedMeta,
							...
							n = this.getParsed(t),
							o = n._custom,
							a = mi(o) ? "[" + o.start + ", " + o.end + "]" : "" + s.getLabelForValue(n[s.axis]);
						return {
						...
						for (let f = e; f < e + i; f++) {
							const e = this.getParsed(f),
								...
								m = {
									horizontal: h,
									base: i.base,
									enableBorderRadius: !p || mi(e._custom) || o === p._top || o === p._bottom,
									x: h ? i.head : g.center,
									y: h ? g.center : i.head,
							...
							xi(m, x, p, o), yi(m, x, c.ratio), this.updateElement(t[f], f, m, s)
						}
					}
					_getStacks(t, e) {
						const {
							iScale: i
						} = this._cachedMeta, s = i.getMatchingVisibleMetas(this._type).filter(t => t.controller.options.grouped), n = i.options.stacked, o = [], r = this._cachedMeta.controller.getParsed(e), l = r && r[i.axis], h = t => {
							const e = t._parsed.find(t => t[i.axis] === l),
								s = e && e[t.vScale.axis];
							if (a(s) || isNaN(s)) return !0
						};
						for (const i of s)
							if ((void 0 === e || !h(i)) && ((!1 === n || -1 === o.indexOf(i.stack) || void 0 === n && void 0 === i.stack) && o.push(i.stack), i.index === t)) break;
					...
					_getAxis() {
						...
						for (const i of this.chart.data.datasets) t[d("x" === this.chart.options.indexAxis ? i.xAxisID : i.yAxisID, e)] = !0;
					...
					_calculateBarValuePixels(t) {
						...
						} = this, r = n || 0, l = this.getParsed(t), h = l._custom, c = mi(h);
						let d, u, f = l[e.axis],
							g = 0,
						...
						if (d = this.chart.getDataVisibility(t) ? e.getPixelForValue(g + p) : x, u = d - x, Math.abs(u) < o) {
							u = function (t, e, i) {
							...
							const t = e.getPixelForDecimal(0),
								...
								a = Math.min(t, n),
								h = Math.max(t, n);
							x = Math.max(Math.min(x, h), a), d = x + u, i && !c && (l._stacks[e.axis]._visualValues[s] = e.getValueForPixel(d) - e.getValueForPixel(x))
						}
					...
					_calculateBarIndexPixels(t, e) {
						...
						if (e.grouped) {
							const i = n ? this._getStackCount(t) : e.stackCount,
								...
								}(t, e, s, i * h) : function (t, e, i, s) {
									const n = i.barThickness;
									let o, r;
									return a(n) ? (o = e.min * i.categoryPercentage, r = i.barPercentage) : (o = n * s, r = 1), {
										chunk: o / s,
										ratio: r,
								...
								g = this._getStackIndex(this.index, this._cachedMeta.stack, n ? t : void 0) + f;
							r = c.start + c.chunk * g + c.chunk / 2, l = Math.min(o, c.chunk * c.ratio)
						} else r = i.getPixelForValue(this.getParsed(t)[i.axis], t), l = Math.min(o, e.min * e.ratio);
						return {
							base: r - l / 2,
							head: r + l / 2,
							center: r,
				...
				BubbleController: class extends ui {
					...
					parseArrayData(t, e, i, s) {
						...
						for (let t = 0; t < n.length; t++) {
							const s = e[i + t];
							n[t]._custom = d(s[2], this.resolveDataElementOptions(t + i).radius)
						}
						return n
					}
					parseObjectData(t, e, i, s) {
						...
						for (let t = 0; t < n.length; t++) {
							const s = e[i + t];
							n[t]._custom = d(s && s.r && +s.r, this.resolveDataElementOptions(t + i).radius)
						}
						return n
					}
					getMaxOverflow() {
					...
					resolveDataElementOptions(t, e) {
						...
						const n = s.radius;
						return "active" !== e && (s.radius = 0), s.radius += d(i && i._custom, n), s
					}
				},
				...
				LineController: class extends ui {
					...
					update(t) {
						...
						this._drawStart = a, this._drawCount = r, ht(e) && (a = 0, r = s.length), i._chart = this.chart, i._datasetIndex = this.index, i._decimated = !!n._decimated, i.points = s;
					...
					updateElements(t, e, i, s) {
						...
						for (let i = 0; i < _; ++i) {
							...
							const v = this.getParsed(i),
								M = a(v[f]),
								w = _[u] = o.getPixelForValue(v[u], i),
								k = _[f] = n || M ? r.getBasePixel() : r.getPixelForValue(l ? this.applyStack(r, v, l) : v[f], i);
							_.skip = isNaN(w) || isNaN(k) || M, _.stop = i > 0 && Math.abs(v[u] - y[u]) > m, p && (_.parsed = v, _.raw = h.data[i]), d && (_.options = c || this.resolveDataElementOptions(i, g.active ? "active" : s)), x || this.updateElement(g, i, _, s), y = v
						}
					}
					getMaxOverflow() {
						const t = this._cachedMeta,
				...
				PieController: class extends vi {
					static id = "pie";
					static defaults = {
						cutout: 0,
						rotation: 0,
				...
				ScatterController: class extends ui {
					...
					update(t) {
						...
						if (this._drawStart = n, this._drawCount = o, ht(e) && (n = 0, o = i.length), this.options.showLine) {
					...
					updateElements(t, e, i, s) {
						const n = "reset" === s,
							...
							x = W(p) ? p : Number.POSITIVE_INFINITY,
						...
						for (let c = e; c < e + i; ++c) {
							const e = t[c],
								...
								M = p[g] = n || y ? r.getBasePixel() : r.getPixelForValue(l ? this.applyStack(r, i, l) : i[g], c);
							p.skip = isNaN(v) || isNaN(M) || y, p.stop = c > 0 && Math.abs(i[f] - _[f]) > x, m && (p.parsed = i, p.raw = h.data[c]), u && (p.options = d || this.resolveDataElementOptions(c, e.active ? "active" : s)), b || this.updateElement(e, c, p, s), _ = i
						}
			...
			function Di(t, e, i, s) {
				const {
					...
					data: o,
					_sorted: r
				} = t, l = n._cachedMeta.iScale, h = t.dataset && t.dataset.options ? t.dataset.options.spanGaps : null;
				if (l && e === l.axis && "r" !== e && r && o.length) {
					const r = l._reversePixels ? tt : Z;
					if (!s) {
						const s = r(o, e, i);
						if (h) {
							const {
								...
								_parsed: i
							} = t, o = i.slice(0, s.lo + 1).reverse().findIndex(t => !a(t[e.axis]));
							s.lo -= Math.max(0, o);
							const r = i.slice(s.hi).findIndex(t => !a(t[e.axis]));
							s.hi += Math.max(0, r)
						}
						return s
					}
			...
			function Oi(t, e, i, s, n) {
				...
				return Ci(t, i, e, function (i, a, r) {
					(n || It(i, t.chartArea, 0)) && i.inRange(e.x, e.y, s) && o.push({
						element: i,
						datasetIndex: a,
						index: r
					})
			...
			function Ai(t, e, i, s, n, o) {
				...
				return Ci(t, i, e, function (i, h, c) {
			...
			function Ti(t, e, i, s, n, o) {
				return o || t.isPointInArea(e) ? "r" !== i || s ? Ai(t, e, i, s, n, o) : function (t, e, i, s) {
					let n = [];
					return Ci(t, i, e, function (t, i, o) {
						const {
							startAngle: a,
							endAngle: r
				...
				modes: {
					index(t, e, i, s) {
						const n = Ce(e, t),
							...
							r = i.intersect ? Oi(t, n, o, s, a) : Ti(t, n, o, !1, s, a),
							l = [];
					...
					dataset(t, e, i, s) {
						const n = Ce(e, t),
							o = i.axis || "xy",
							a = i.includeInvisible || !1;
						let r = i.intersect ? Oi(t, n, o, s, a) : Ti(t, n, o, !1, s, a);
						if (r.length > 0) {
					...
					point: (t, e, i, s) => Oi(t, Ce(e, t), i.axis || "xy", s, i.includeInvisible || !1),
					nearest(t, e, i, s) {
						const n = Ce(e, t),
							o = i.axis || "xy",
							a = i.includeInvisible || !1;
						return Ti(t, n, o, i.intersect, s, a)
					},
					x: (t, e, i, s) => Li(t, Ce(e, t), "x", i.intersect, s),
					y: (t, e, i, s) => Li(t, Ce(e, t), "y", i.intersect, s)
				}
			};
			const Ri = ["left", "top", "right", "bottom"];
			...
			function zi(t, e) {
				return t.filter(t => -1 === Ri.indexOf(t.pos) && t.box.axis === e)
			}
			...
			function Ni(t, e, i, s) {
				...
				const r = Math.max(0, e.outerWidth - Bi(a, t, "left", "right")),
					h = Math.max(0, e.outerHeight - Bi(a, t, "top", "bottom")),
					c = r !== t.w,
					d = h !== t.h;
				return t.w = r, t.h = h, i.horizontal ? {
					same: c,
					other: d
				} : {
					same: d,
			...
			function ji(t, e, i, s) {
				...
				for (o = 0, a = t.length, h = 0; o < a; ++o) {
					r = t[o], l = r.box, l.update(r.width || e.w, r.height || e.h, Hi(r.horizontal, e));
					const {
						same: a,
						other: d
					} = Ni(e, i, r, s);
			...
			function Ui(t, e, i, s) {
				...
				for (const r of t) {
					...
					if (r.horizontal) {
						const s = e.w * h,
							o = l.size || t.height;
						S(l.start) && (a = l.start), t.fullSize ? $i(t, n.left, a, i.outerWidth - n.right - n.left, o) : $i(t, e.left + l.placed, a, s, o), l.start = a, l.placed += s, a = t.bottom
					} else {
						const s = e.h * h,
							a = l.size || t.width;
						S(l.start) && (o = l.start), t.fullSize ? $i(t, o, n.top, a, i.outerHeight - n.bottom - n.top) : $i(t, o, e.top + l.placed, a, s), l.start = o, l.placed += s, o = t.right
					}
				}
				e.x = o, e.y = a
			}
			var Yi = {
				...
				update(t, e, i, s) {
					if (!t) return;
					const n = Jt(t.options.layout.padding),
						...
						r = function (t) {
							const e = function (t) {
								...
								i = Fi(e.filter(t => t.box.fullSize), !0),
								s = Fi(Ii(e, "left"), !0),
								n = Fi(Ii(e, "right")),
								o = Fi(Ii(e, "top"), !0),
								a = Fi(Ii(e, "bottom")),
					...
					const f = Object.assign({
						...
						p = Vi(l.concat(h), d);
					ji(r.fullSize, f, d, p), ji(l, f, d, p), ji(h, f, d, p) && ji(l, f, d, p),
						function (t) {
						...
						}(f), Ui(r.leftAndTop, f, d, p), f.x += f.w, f.y += f.h, Ui(r.rightAndBottom, f, d, p), t.chartArea = {
							left: f.left,
							top: f.top,
							right: f.left + f.w,
							bottom: f.top + f.h,
			...
			function Zi(t, e, i) {
				t && t.canvas && t.canvas.removeEventListener(e, i, Qi)
			}
			...
			function ds(t, e) {
				...
				if (r > 0) {
					let t, i;
					const s = r > 1 ? Math.round((h - l) / (r - 1)) : null;
					for (us(e, c, d, a(s) ? 0 : l - s, l), t = 0, i = r - 1; t < i; t++) us(e, c, d, o[t], o[t + 1]);
					return us(e, c, d, h, a(s) ? e.length : h + s), c
				}
				return us(e, c, d), c
			}
			...
			function us(t, e, i, s, n) {
				const o = d(s, 0),
					a = Math.min(d(n, t.length), t.length);
				let r, l, h, c = 0;
			...
			const fs = (t, e, i) => "top" === e || "left" === e ? t[e] + i : t[e] - i,
			...
			class ys extends cs {
				...
				update(t, e, i) {
					...
					this._convertTicksToLabels(r ? ps(this.ticks, a) : this.ticks), this.configure(), this.beforeCalculateLabelRotation(), this.calculateLabelRotation(), this.afterCalculateLabelRotation(), o.display && (o.autoSkip || "auto" === o.source) && (this.ticks = ds(this, this.ticks), this._labelSizes = null, this.afterAutoSkip()), r && this._convertTicksToLabels(this.ticks), this.beforeFit(), this.fit(), this.afterFit(), this.afterUpdate()
				}
				configure() {
				...
				calculateLabelRotation() {
					...
					o = t.offset ? this.maxWidth / i : u / (i - 1), c + 6 > o && (o = u / (i - (t.offset ? .5 : 1)), a = this.maxHeight - xs(t.grid) - e.padding - bs(t.title, this.chart.options.font), r = Math.sqrt(c * c + d * d), l = j(Math.min(Math.asin(G((h.highest.height + 6) / o, -1, 1)), Math.asin(G(a / r, -1, 1)) - Math.asin(G(d / r, -1, 1)))), l = Math.max(s, Math.min(n, l))), this.labelRotation = l
				}
				...
				fit() {
					...
					if (o) {
						...
						if (a ? (t.width = this.maxWidth, t.height = xs(n) + o) : (t.height = this.maxHeight, t.width = xs(n) + o), i.display && this.ticks.length) {
							const {
								first: e,
								last: s,
								widest: n,
				...
				_getLabelSizes() {
					...
					if (!t) {
						...
						let i = this.ticks;
						e < i.length && (i = ps(i, e)), this._labelSizes = t = this._computeLabelSizes(i, i.length, this.options.ticks.maxTicksLimit)
					}
					return t
				}
				_computeLabelSizes(t, e, i) {
					const {
						ctx: s,
						_longestTextCache: n
					} = this, o = [], l = [], h = Math.floor(e / gs(e, i));
					let c, d, u, f, p, m, x, b, _, y, v, M = 0,
						w = 0;
					for (c = 0; c < e; c += h) {
						if (f = t[c].label, p = this._resolveTickFontOptions(c), s.font = m = p.string, x = n[m] = n[m] || {
								data: {},
								gc: []
							}, b = p.lineHeight, _ = y = 0, a(f) || r(f)) {
							if (r(f))
								for (d = 0, u = f.length; d < u; ++d) v = f[d], a(v) || r(v) || (_ = Ot(s, x.data, x.gc, _, v), y += b)
						} else _ = Ot(s, x.data, x.gc, _, f), y = b;
						o.push(_), l.push(y), M = Math.max(_, M), w = Math.max(y, w)
					}! function (t, e) {
						g(t, t => {
							const i = t.gc,
								s = i.length / 2;
				...
				getPixelForDecimal(t) {
					...
					return G(this._alignToPixels ? Tt(this.chart, e, 0) : e, -32768, 32767)
				}
				...
				getContext(t) {
					...
					return this.$context || (this.$context = te(this.chart.getContext(), {
						scale: this,
						type: "scale"
					}))
				}
				...
				_computeGridLineItems(t) {
					...
					if ("top" === o) b = x(this.bottom), w = this.bottom - u, S = b - m, D = x(t.top) + m, O = t.bottom;
					else if ("bottom" === o) b = x(this.top), D = t.top, O = x(t.bottom) - m, w = b + m, S = this.top + u;
					else if ("left" === o) b = x(this.right), M = this.right - u, k = b - m, P = x(t.left) + m, C = t.right;
					else if ("right" === o) b = x(this.left), P = t.left, C = x(t.right) - m, M = b + m, k = this.left + u;
					else if ("x" === e) {
						if ("center" === o) b = x((t.top + t.bottom) / 2 + .5);
						else if (l(o)) {
						...
						if ("center" === o) b = x((t.left + t.right) / 2);
						else if (l(o)) {
							const t = Object.keys(o)[0],
								e = o[t];
							b = x(this.chart.scales[t].getPixelForValue(e))
					...
					const A = d(s.ticks.maxTicksLimit, c),
					...
					for (_ = 0; _ < c; _ += T) {
						...
						y = ms(this, _, r), void 0 !== y && (v = Tt(i, y, o), h ? M = k = P = C = v : w = S = D = O = v, f.push({
							tx1: M,
							ty1: w,
							tx2: k,
							ty2: S,
				...
				_computeLabelItems(t) {
					...
					for (b = 0, _ = a.length; b < _; ++b) {
						...
						S = this.getPixelForTick(b) + n.labelOffset, P = this._resolveTickFontOptions(b), D = P.lineHeight, C = r(v) ? v.length : 1;
						const e = C / 2,
							i = t.color,
							l = t.textStrokeColor,
							h = t.textStrokeWidth;
						let d, f = k;
						if (o ? (M = S, "inner" === k && (f = b === _ - 1 ? this.options.reverse ? "left" : "right" : 0 === b ? this.options.reverse ? "right" : "left" : "center"), O = "top" === s ? "near" === c || 0 !== m ? -C * D + D / 2 : "center" === c ? -T.highest.height / 2 - e * D + D : -T.highest.height + D / 2 : "near" === c || 0 !== m ? D / 2 : "center" === c ? T.highest.height / 2 - e * D : T.highest.height - C * D, u && (O *= -1), 0 === m || t.showLabelBackdrop || (M += D / 2 * Math.sin(m))) : (w = S, O = (1 - C) * D / 2), t.showLabelBackdrop) {
							const e = Jt(t.backdropPadding),
								i = T.heights[b],
								s = T.widths[b];
							let n = O - e.top,
								o = 0 - e.left;
				...
				drawBorder() {
					...
					const a = s.setContext(this.getContext(0)).lineWidth,
						r = this._borderValue;
					let l, h, c, d;
					this.isHorizontal() ? (l = Tt(t, this.left, o) - o / 2, h = Tt(t, this.right, a) + a / 2, c = d = r) : (c = Tt(t, this.top, o) - o / 2, d = Tt(t, this.bottom, a) + a / 2, l = h = r), e.save(), e.lineWidth = n.width, e.strokeStyle = n.color, e.beginPath(), e.moveTo(l, c), e.lineTo(h, d), e.stroke(), e.restore()
				}
				drawLabels(t) {
					...
					for (const t of s) {
						const i = t.options,
							s = t.font;
						Ht(e, t.label, 0, t.textOffset, s, i)
					}
					i && Ft(e)
				}
				drawTitle() {
					...
					"bottom" === e || "center" === e || l(e) ? (h += o.bottom, r(i.text) && (h += n.lineHeight * (i.text.length - 1))) : h += o.top;
					const {
						titleX: c,
						titleY: d,
						maxWidth: u,
						...
						if (t.isHorizontal()) {
							...
							} else g = "center" === i ? (c.bottom + c.top) / 2 + m - e : fs(t, i, e);
							u = r - o
						} else {
							if (l(i)) {
								const t = Object.keys(i)[0],
							...
							} else f = "center" === i ? (c.left + c.right) / 2 - x + e : fs(t, i, e);
							g = rt(s, a, n), p = "left" === i ? -E : E
						}
						return {
							titleX: f,
							titleY: g,
				...
				_resolveTickFontOptions(t) {
					return Qt(this.options.ticks.setContext(this.getContext(t)).font)
				}
				_maxDigits() {
			...
			class vs {
				...
				register(t) {
					...
					return n in s || (s[n] = t, function (t, e, i) {
						const s = _(Object.create(null), [i ? Ct.get(i) : {}, Ct.get(e), t.defaults]);
						Ct.set(e, s), t.defaultRoutes && function (t, e) {
						...
						t.descriptors && Ct.describe(e, t.descriptors)
					}(t, o, i), this.override && Ct.override(t.id, t.overrides)), o
				}
				get(t) {
					return this.items[t]
				}
				unregister(t) {
					const e = this.items,
						i = t.id,
						s = this.scope;
					i in e && delete e[i], s && i in Ct[s] && (delete Ct[s][i], this.override && delete wt[i])
				}
			}
			class Ms {
				constructor() {
					this.controllers = new vs(ui, "datasets", !0), this.elements = new vs(cs, "elements"), this.plugins = new vs(Object, "plugins"), this.scales = new vs(ys, "scales"), this._typedRegistries = [this.controllers, this.scales, this.elements]
				}
				add(...t) {
				...
				_each(t, e, i) {
					[...e].forEach(e => {
						...
						i || s.isForType(e) || s === this.plugins && e.id ? this._exec(t, s, e) : g(e, e => {
							const s = i || this._getRegistryForType(e);
							this._exec(t, s, e)
						})
					})
			...
			function As(t, ...e) {
				if (Cs(t)) return t;
				for (const i of e) {
					const e = i.axis || Os(i.position) || t.length > 1 && Cs(t[0].toLowerCase());
					if (e) return e
				}
				...
				return Object.keys(s).forEach(e => {
					...
					Object.keys(r).forEach(t => {
						const e = function (t, e) {
							...
							n = i[e + "AxisID"] || e;
						o[n] = o[n] || Object.create(null), y(o[n], [{
							axis: e
						}, s[n], r[t]])
					})
				}), Object.keys(o).forEach(t => {
					const e = o[t];
					y(e, [Ct.scales[e.type], Ct.scale])
				}), o
			}

			function Es(t) {
				const e = t.options || (t.options = {});
				e.plugins = d(e.plugins, {}), e.scales = Ls(t, e)
			}
			...
			function Fs(t, e) {
				let i = Is.get(t);
				return i || (i = e(), Is.set(t, i), zs.add(i)), i
			}
			const Vs = (t, e, i) => {
				const s = w(e, i);
				void 0 !== s && t.add(s)
			...
			class Bs {
				constructor(t) {
					this._config = function (t) {
						return (t = t || {}).data = Rs(t.data), Es(t), t
				...
				getOptionScopes(t, e, i) {
					...
					const r = new Set;
					e.forEach(e => {
						t && (r.add(t), e.forEach(e => Vs(r, t, e))), e.forEach(t => Vs(r, s, t)), e.forEach(t => Vs(r, wt[n] || {}, t)), e.forEach(t => Vs(r, Ct, t)), e.forEach(t => Vs(r, kt, t))
					});
					...
					if (function (t, e) {
							...
							for (const n of e) {
								const e = i(n),
									o = s(n),
									a = (o || e) && t[n];
								if (e && (P(a) || Ns(a)) || o && r(a)) return !0
							}
							return !1
						}(o, e)) {
						n.$shared = !1;
						l = ie(o, i = P(i) ? i() : i, this.createResolver(t, i, a))
					}
			...
			const Ns = t => l(t) && Object.getOwnPropertyNames(t).some(e => P(t[e]));
			...
			function Xs(t) {
				return Me() && "string" == typeof t ? t = document.getElementById(t) : t && t.length && (t = t[0]), t && t.canvas && (t = t.canvas), t
			}
			const qs = {},
				Ks = t => {
					const e = Xs(t);
					return Object.values(qs).filter(t => t.canvas === e).pop()
				};
			...
			class Js {
				...
				constructor(t, e) {
					...
					this.platform = new(i.platform || function (t) {
						return !Me() || "undefined" != typeof OffscreenCanvas && t instanceof OffscreenCanvas ? qi : hs
					}(s)), this.platform.updateConfig(i);
					const r = this.platform.acquireContext(s, a.aspectRatio),
						l = r && r.canvas,
						h = l && l.height,
						c = l && l.width;
					this.id = o(), this.ctx = r, this.canvas = l, this.width = c, this.height = h, this._options = a, this._aspectRatio = this.aspectRatio, this._layers = [], this._metasets = [], this._stacks = void 0, this.boxes = [], this.currentDevicePixelRatio = void 0, this.chartArea = void 0, this._active = [], this._lastEvent = void 0, this._listeners = {}, this._responsiveListeners = void 0, this._sortedMetasets = [], this.scales = {}, this._plugins = new ks, this.$proxies = {}, this._hiddenIndices = {}, this.attached = !1, this._animationsDisabled = void 0, this.$context = void 0, this._doResize = function (t, e) {
						let i;
						return function (...s) {
							return e ? (clearTimeout(i), i = setTimeout(t, e, s)) : t.apply(this, s), e
						}
					}(t => this.update(t), a.resizeDelay || 0), this._dataChanges = [], qs[this.id] = this, r && l && (Ge.listen(this, "complete", Us), Ge.listen(this, "progress", Ys), this._initialize(), this.attached && this.update())
				}
				get aspectRatio() {
					const {
						options: {
				...
				clear() {
					return Lt(this.canvas, this.ctx), this
				}
				stop() {
				...
				_resize(t, e) {
					...
					this.width = o.width, this.height = o.height, this._aspectRatio = this.aspectRatio, Te(this, a, !0) && (this.notifyPlugins("resize", {
						size: o
					}), f(i.onResize, [this, o], this), this.attached && this._doResize(r) && this.render())
				}
				ensureScalesHaveIDs() {
				...
				buildOrUpdateScales() {
					...
					e && (n = n.concat(Object.keys(e).map(t => {
						...
						const n = e.options,
							...
							a = As(o, n),
							r = d(n.type, e.dtype);
						void 0 !== n.position && js(n.position, a) === js(e.dposition) || (n.position = e.dposition), s[o] = !0;
						let l = null;
						...
						Yi.configure(this, t, t.options), Yi.addBox(this, t)
					})
				}
				_updateMetasets() {
				...
				buildOrUpdateControllers() {
					...
					for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
						...
						if (n.type && n.type !== o && (this._destroyDatasetMeta(i), n = this.getDatasetMeta(i)), n.type = o, n.indexAxis = s.indexAxis || Ds(o, this.options), n.order = s.order || 0, n.index = i, n.label = "" + s.label, n.visible = this.isDatasetVisible(i), n.controller) n.controller.updateIndex(i), n.controller.linkScales();
						else {
				...
				update(t) {
					...
					o = this._minPadding = i.layout.autoPadding ? o : 0, this._updateLayout(o), s || g(n, t => {
						t.reset()
				...
				_updateLayout(t) {
					...
					Yi.update(this, this.width, this.height, t);
					const e = this.chartArea,
						i = e.width <= 0 || e.height <= 0;
					this._layers = [], g(this.boxes, t => {
				...
				_updateDatasets(t) {
					if (!1 !== this.notifyPlugins("beforeDatasetsUpdate", {
						...
						for (let e = 0, i = this.data.datasets.length; e < i; ++e) this._updateDataset(e, P(t) ? t({
							datasetIndex: e
						}) : t);
				...
				render() {
					!1 !== this.notifyPlugins("beforeRender", {
						cancelable: !0
					}) && (Ge.has(this) ? this.attached && !Ge.running(this) && Ge.start(this) : (this.draw(), Us({
						chart: this
					})))
				}
				draw() {
				...
				_drawDataset(t) {
					const e = this.ctx,
						...
						s = qe(this, t);
					!1 !== this.notifyPlugins("beforeDatasetDraw", i) && (s && zt(e, s), t.controller.draw(), s && Ft(e), i.cancelable = !1, this.notifyPlugins("afterDatasetDraw", i))
				}
				isPointInArea(t) {
				...
				getContext() {
					return this.$context || (this.$context = te(null, {
						chart: this,
						type: "chart"
					}))
				}
				...
				_updateVisibility(t, e, i) {
					...
					S(e) ? (n.data[e].hidden = !i, this.update()) : (this.setDatasetVisibility(t, i), o.update(n, {
						visible: i
				...
				_stop() {
					let t, e;
					for (this.stop(), Ge.remove(this), t = 0, e = this.data.datasets.length; t < e; ++t) this._destroyDatasetMeta(t)
				}
				destroy() {
					...
					this._stop(), this.config.clearCache(), t && (this.unbindEvents(), Lt(t, e), this.platform.releaseContext(e), this.canvas = null, this.ctx = null), delete qs[this.id], this.notifyPlugins("afterDestroy")
				}
				toBase64Image(...t) {
				...
				_handleEvent(t, e, i) {
					...
					i && (this._lastEvent = null, f(n.onHover, [t, a, this], this), r && f(n.onClick, [t, a, this], this));
					const h = !p(a, s);
			...
			function Qs() {
				return g(Js.instances, t => t._plugins.invalidate())
			}

			function Zs(t, e, i, s) {
				const n = qt(t.options.borderRadius, ["outerStart", "outerEnd", "innerStart", "innerEnd"]);
				const o = (i - e) / 2,
					a = Math.min(o, s * e / 2),
					r = t => {
			...
			function sn(t, e, i, s, n) {
				...
				g && function (t, e, i) {
					...
					const {
						...
						borderWidth: h,
						borderJoinStyle: c
					} = l, d = Math.min(h / a, q(s - i));
					if (t.beginPath(), t.arc(n, o, a - h / 2, s + d / 2, i - d / 2), r > 0) {
						const e = Math.min(h / r, q(s - i));
						t.arc(n, o, r + h / 2, i - e / 2, s + e / 2, !0)
					} else {
						const e = Math.min(h / 2, a * q(s - i));
				...
				}(t, e, p), o || (en(t, e, i, s, p, n), t.stroke())
			}
			...
			function rn(t, e, i, s) {
				const {
					...
					loop: l,
					ilen: h
				} = an(n, i, s), c = function (t) {
					return t.stepped ? Vt : t.tension || "monotone" === t.cubicInterpolationMode ? Bt : on
				}(o);
				let d, u, f, {
					move: g = !0,
					reverse: p
			...
			function dn(t, e, i, s) {
				cn && !e.options.segment ? function (t, e, i, s) {
					let n = e._path;
					n || (n = e._path = new Path2D, e.path(n, i, s) && n.closePath()), nn(t, e.options), t.stroke(n)
				}(t, e, i, s) : function (t, e, i, s) {
					const {
						segments: n,
						options: o
					} = e, a = hn(e);
					for (const r of n) nn(t, o, r.style), t.beginPath(), a(t, e, r, {
						start: i,
						end: i + s - 1
			...
			class un extends cs {
				...
				interpolate(t, e) {
					...
					const a = [],
						r = function (t) {
							return t.stepped ? Ie : t.tension || "monotone" === t.cubicInterpolationMode ? ze : Re
						}(i);
					let l, h;
				...
				draw(t, e, i, s) {
					...
					(this.points || []).length && n.borderWidth && (t.save(), dn(t, this, i, s), t.restore()), this.animated && (this._pointsUpdated = !1, this._path = void 0)
				}
			}
				...
				const e = gn(t),
					...
					n = function (t, e, i) {
						const s = t.options.borderWidth,
							...
							o = Kt(s);
						return {
							t: pn(n.top, o.top, 0, i),
							r: pn(n.right, o.right, 0, e),
							b: pn(n.bottom, o.bottom, 0, i),
							l: pn(n.left, o.left, 0, e)
						}
					}(t, i / 2, s / 2),
					o = function (t, e, i) {
						const {
							enableBorderRadius: s
						} = t.getProps(["enableBorderRadius"]), n = t.options.borderRadius, o = Gt(n), a = Math.min(e, i), r = t.borderSkipped, h = s || l(n);
						return {
							topLeft: pn(!h || r.top || r.left, o.topLeft, 0, a),
							topRight: pn(!h || r.top || r.right, o.topRight, 0, a),
							bottomLeft: pn(!h || r.bottom || r.left, o.bottomLeft, 0, a),
							bottomRight: pn(!h || r.bottom || r.right, o.bottomRight, 0, a)
						}
					}(t, i / 2, s / 2);
				return {
					outer: {
			...
			var yn = Object.freeze({
					...
					draw(t) {
						...
						t.fillStyle = e.backgroundColor, t.strokeStyle = e.borderColor,
							function (t, e, i, s, n) {
								...
								en(t, e, i, s, l, n), t.fill()
							}(t, this, r, n, o), sn(t, this, r, n, o), t.restore()
					}
				},
				BarElement: class extends cs {
					static id = "bar";
					static defaults = {
						borderSkipped: "start",
						borderWidth: 0,
					...
					draw(t) {
						const {
							...
							inner: n,
							outer: o
						} = mn(this), a = (r = o.radius).topLeft || r.topRight || r.bottomLeft || r.bottomRight ? jt : bn;
						var r;
						t.save(), o.w === n.w && o.h === n.h || (t.beginPath(), a(t, _n(o, e, n)), t.clip(), a(t, _n(n, -e, o)), t.fillStyle = i, t.fill("evenodd")), t.beginPath(), a(t, _n(n, e)), t.fillStyle = s, t.fill(), t.restore()
					}
					inRange(t, e, i) {
				...
				PointElement: class extends cs {
					...
					draw(t, e) {
						const i = this.options;
						this.skip || i.radius < .1 || !It(this, e, this.size(i) / 2) || (t.strokeStyle = i.borderColor, t.lineWidth = i.borderWidth, t.fillStyle = i.backgroundColor, Et(t, i, this.x, this.y))
					}
					getRange() {
						const t = this.options || {};
			...
			const vn = ["rgb(54, 162, 235)", "rgb(255, 99, 132)", "rgb(255, 159, 64)", "rgb(255, 205, 86)", "rgb(75, 192, 192)", "rgb(153, 102, 255)", "rgb(201, 203, 207)"],
				Mn = vn.map(t => t.replace("rgb(", "rgba(").replace(")", ", 0.5)"));
			...
			function Sn(t) {
				...
				return (i, s) => {
					...
					n instanceof vi ? e = function (t, e) {
						return t.backgroundColor = t.data.map(() => wn(e++)), e
					}(i, e) : n instanceof Mi ? e = function (t, e) {
						return t.backgroundColor = t.data.map(() => kn(e++)), e
					}(i, e) : n && (e = function (t, e) {
						return t.borderColor = wn(e), t.backgroundColor = kn(e), ++e
					}(i, e))
				}
			}
			...
			var Dn = {
				...
				beforeLayout(t, e, i) {
					...
					const {
						...
						elements: o
					} = n, a = Pn(s) || (r = n) && (r.borderColor || r.backgroundColor) || o && Pn(o) || "rgba(0,0,0,0.1)" !== Ct.borderColor || "rgba(0,0,0,0.1)" !== Ct.backgroundColor;
					var r;
			...
			var An = {
				...
				beforeElementsUpdate: (t, e, i) => {
					...
					t.data.datasets.forEach((e, n) => {
						...
						if ("y" === Zt([r, t.options.indexAxis])) return;
						...
						let {
							...
							return l && (n = G(Z(e, o.axis, a).lo, 0, i - 1)), s = h ? G(Z(e, o.axis, r).hi + 1, n, i) - n : i - n, {
								start: n,
								count: s
							}
						}(l, h);
						if (u <= (i.threshold || 4 * s)) return void Cn(e);
						let f;
						switch (a(o) && (e._data = h, delete e.data, Object.defineProperty(e, "data", {
							configurable: !0,
							enumerable: !0,
							get: function () {
								...
								f = function (t, e, i, s) {
									...
									for (n = e; n < e + i; ++n) {
										...
										if (e === h) l < f ? (f = l, c = n) : l > g && (g = l, d = n), p = (m * p + o.x) / ++m;
											...
											n > 0 && i !== u && x.push(t[i]), x.push(o), h = e, m = 0, f = g = l, c = d = u = n
										}
									}
									return x
								}(h, d, u, s);
			...
			function Rn(t, e) {
				let i = [],
					s = !1;
				return r(t) ? (s = !0, i = t) : i = function (t, e) {
					const {
						x: i = null,
						y: s = null
					} = t || {}, n = e.points, o = [];
			...
			function Fn(t, e, i) {
				const s = function (t) {
					const e = t.options,
						i = e.fill;
					let s = d(i && i.target, i);
					void 0 === s && (s = !!e.backgroundColor);
					if (!1 === s || null === s) return !1;
					if (!0 === s) return "origin";
					return s
				}(t);
				if (l(s)) return !isNaN(s.value) && s;
				let n = parseFloat(s);
				return h(n) && Math.floor(n) === n ? function (t, e, i, s) {
					"-" !== t && "+" !== t || (i = e + i);
			...
			function Nn(t) {
				...
				if ("stack" === i) return function (t) {
					...
					for (let t = 0; t < o.length; t++) {
						const e = o[t];
						for (let t = e.start; t <= e.end; t++) Vn(n, a[t], r)
					}
					return new un({
						points: n,
						options: {}
				...
				const n = function (t) {
					...
					if (e.getPointPositionForValue) return function (t) {
						const {
							...
							let s;
							return s = "start" === t ? i : "end" === t ? e.options.reverse ? e.min : e.max : l(t) ? t.value : e.getBaseValue(), s
						}(i, e, o), r = [];
						if (s.grid.circular) {
					...
					return function (t) {
						const {
							...
							let i = null;
							return "start" === t ? i = e.bottom : "end" === t ? i = e.top : l(t) ? i = e.getPixelForValue(t.value) : e.getBasePixel && (i = e.getBasePixel()), i
						}(i, e);
						if (h(s)) {
				...
				return n instanceof Wn ? n : Rn(n, s)
			}
			...
			function Hn(t, e, i) {
				const s = Nn(e),
					...
					p = qe(n, g);
				s && a.points.length && (zt(t, i), function (t, e) {
					const {
						line: i,
						target: s,
						above: n,
					...
					o !== n && ("x" === h ? (jn(t, s, a.top), Un(t, {
						...
						property: h,
						clip: l
					}), t.restore(), t.save(), jn(t, s, a.bottom)) : "y" === h && ($n(t, s, a.left), Un(t, {
						line: i,
						target: s,
						color: o,
						scale: r,
						property: h,
						clip: l
					}), t.restore(), t.save(), $n(t, s, a.right), c = n));
					Un(t, {
						line: i,
						target: s,
						color: c,
			...
			function Un(t, e) {
					...
					for (const t of s) {
						...
						for (const e of h) {
							...
							for (const t of r) a.push({
								...
								target: e,
								start: {
									[i]: En(l, s, "start", Math.max)
								},
								end: {
									[i]: En(l, s, "end", Math.min)
								}
							})
						}
					}
				...
				for (const {
					...
					t.save(), t.fillStyle = l, Yn(t, a, r, u && Tn(n, c, d)), t.beginPath();
					const f = !!i.pathSegment(t, e);
					let g;
					if (u) {
						f ? t.closePath() : Xn(t, s, d, n);
			...
			var qn = {
				...
				beforeDraw(t, e, i) {
					...
					for (let e = n.length - 1; e >= 0; --e) {
						const i = n[e].$filler;
						i && (i.line.updateControlPoints(o, i.axis), s && i.fill && Hn(t.ctx, i, o))
					}
				},
				beforeDatasetsDraw(t, e, i) {
					...
					for (let e = s.length - 1; e >= 0; --e) {
						const i = s[e].$filler;
						In(i) && Hn(t.ctx, i, t.chartArea)
					}
				},
				beforeDatasetDraw(t, e, i) {
					const s = e.meta.$filler;
					In(s) && "beforeDatasetDraw" === i.drawTime && Hn(t.ctx, s, t.chartArea)
				},
				defaults: {
					propagate: !0,
			...
			class Gn extends cs {
				...
				adjustHitBoxes() {
					...
					const t = this._computeTitleHeight(),
						...
						o = Fe(n, this.left, this.width);
					if (this.isHorizontal()) {
						let n = 0,
							a = rt(i, this.left + s, this.right - this.lineWidths[n]);
						for (const r of e) n !== r.row && (n = r.row, a = rt(i, this.left + s, this.right - this.lineWidths[n])), r.top += this.top + t + s, r.left = o.leftForLtr(o.x(a), r.width), a += r.width + s
					} else {
						let n = 0,
							a = rt(i, this.top + t + s, this.bottom - this.columnSizes[n].height);
						for (const r of e) r.col !== n && (n = r.col, a = rt(i, this.top + t + s, this.bottom - this.columnSizes[n].height)), r.top = a, r.left += this.left + s, r.left = o.leftForLtr(o.x(r.left), r.width), a += r.height + s
					}
				}
				isHorizontal() {
				...
				_draw() {
					const {
						...
						align: n,
						labels: o
					} = t, a = Ct.color, r = Fe(t.rtl, this.left, this.width), l = Qt(o.font), {
						padding: h
					} = o, c = l.size, u = c / 2;
					let f;
					...
					const {
						...
						boxHeight: p,
						itemHeight: m
					} = Kn(o, c), x = this.isHorizontal(), b = this._computeTitleHeight();
					f = x ? {
						x: rt(n, this.left + h, this.right - i[0]),
						y: this.top + h + b,
						line: 0
					} : {
						x: this.left + h,
						y: rt(n, this.top + b + h, this.bottom - e[0].height),
						line: 0
					}, Ve(this.ctx, t.textDirection);
					const _ = m + h;
					this.legendItems.forEach((y, v) => {
						...
						let S = f.x,
							P = f.y;
						r.setWidth(this.width), x ? v > 0 && S + k + h > this.right && (P = f.y += _, f.line++, S = f.x = rt(n, this.left + h, this.right - i[f.line])) : v > 0 && P + _ > this.bottom && (S = f.x = S + e[f.line].width + h, f.line++, P = f.y = rt(n, this.top + b + h, this.bottom - e[f.line].height));
						if (function (t, e, i) {
								if (isNaN(g) || g <= 0 || isNaN(p) || p < 0) return;
								s.save();
								const n = d(i.lineWidth, 1);
								if (s.fillStyle = d(i.fillStyle, a), s.lineCap = d(i.lineCap, "butt"), s.lineDashOffset = d(i.lineDashOffset, 0), s.lineJoin = d(i.lineJoin, "miter"), s.lineWidth = n, s.strokeStyle = d(i.strokeStyle, a), s.setLineDash(d(i.lineDash, [])), o.usePointStyle) {
									const a = {
										...
										l = r.xPlus(t, g / 2);
									Rt(s, a, l, e + u, o.pointStyleWidth && g)
								} else {
									const o = e + Math.max((c - p) / 2, 0),
										a = r.leftForLtr(t, g),
										l = Gt(i.borderRadius);
									s.beginPath(), Object.values(l).some(t => 0 !== t) ? jt(s, {
										x: a,
										y: o,
										w: g,
										h: p,
								...
								s.restore()
							}(r.x(S), P, y), S = ((t, e, i, s) => t === (s ? "left" : "right") ? i : "center" === t ? (e + i) / 2 : e)(w, S + g + u, x ? S + k : this.right, t.rtl), function (t, e, i) {
								Ht(s, i.text, t, e + m / 2, l, {
				...
				drawTitle() {
					const t = this.options,
						...
						s = Jt(e.padding);
					if (!e.display) return;
					const n = Fe(t.rtl, this.left, this.width),
						o = this.ctx,
						a = e.position,
						r = i.size / 2,
						l = s.top + r;
					let h, c = this.left,
						d = this.width;
					if (this.isHorizontal()) d = Math.max(...this.lineWidths), h = this.top + l, c = rt(t.align, c, this.right - d);
					else {
						const e = this.columnSizes.reduce((t, e) => Math.max(t, e.height), 0);
						h = l + rt(t.align, this.top, this.bottom - e - t.labels.padding - this._computeTitleHeight())
					}
					const u = rt(a, c, c + d);
					o.textAlign = n.textAlign(at(a)), o.textBaseline = "middle", o.strokeStyle = e.color, o.fillStyle = e.color, o.font = i.string, Ht(o, e.text, u, h, i)
				}
				_computeTitleHeight() {
				...
				handleEvent(t) {
					...
					if ("mousemove" === t.type || "mouseout" === t.type) {
						...
						o && !a && f(e.onLeave, [t, o, this], this), this._hoveredItem = i, i && !a && f(e.onHover, [t, i, this], this)
			...
			var Qn = {
				...
				_element: Gn,
				start(t, e, i) {
					const s = t.legend = new Gn({
						ctx: t.ctx,
						options: i,
						chart: t
					});
					Yi.configure(t, s, i), Yi.addBox(t, s)
				},
				stop(t) {
					Yi.removeBox(t, t.legend), delete t.legend
				},
				beforeUpdate(t, e, i) {
					const s = t.legend;
					Yi.configure(t, s, i), s.options = i
				},
				afterUpdate(t) {
					const e = t.legend;
			...
			class Zn extends cs {
				...
				update(t, e) {
					...
					const s = r(i.text) ? i.text.length : 1;
					this._padding = Jt(i.padding);
					const n = s * Qt(i.font).lineHeight + this._padding.height;
				...
				_drawArgs(t) {
					...
					let r, l, h, c = 0;
					return this.isHorizontal() ? (l = rt(a, i, n), h = e + t, r = n - i) : ("left" === o.position ? (l = i + t, h = rt(a, s, e), c = -.5 * C) : (l = n - t, h = rt(a, e, s), c = .5 * C), r = s - e), {
						titleX: l,
						titleY: h,
						maxWidth: r,
						rotation: c
			...
			var to = {
				...
				start(t, e, i) {
					! function (t, e) {
						...
						Yi.configure(t, i, e), Yi.addBox(t, i), t.titleBlock = i
					}(t, i)
				},
				stop(t) {
					const e = t.titleBlock;
					Yi.removeBox(t, e), delete t.titleBlock
				},
				beforeUpdate(t, e, i) {
			...
			var io = {
				...
				start(t, e, i) {
					...
					Yi.configure(t, s, i), Yi.addBox(t, s), eo.set(t, s)
				},
				stop(t) {
					Yi.removeBox(t, eo.get(t)), eo.delete(t)
				},
				beforeUpdate(t, e, i) {
					const s = eo.get(t);
					Yi.configure(t, s, i), s.options = i
			...
			function ro(t, e) {
				...
				if (b += t.beforeBody.length + t.afterBody.length, d && (m += d * h.lineHeight + (d - 1) * e.titleSpacing + e.titleMarginBottom), b) {
					m += f * (e.displayColors ? Math.max(r, l.lineHeight) : l.lineHeight) + (b - f) * l.lineHeight + (b - 1) * e.bodySpacing
				}
				...
				return i.save(), i.font = h.string, g(t.title, y), i.font = l.string, g(t.beforeBody.concat(t.afterBody), y), _ = e.displayColors ? a + 2 + e.boxPadding : 0, g(s, t => {
					g(t.before, y), g(t.lines, y), g(t.after, y)
				}), _ = 0, i.font = c.string, g(t.footer, y), i.restore(), x += p.width, {
					width: x,
					height: m
				}
			}
			...
			class xo extends cs {
				...
				getContext() {
					return this.$context || (this.$context = (t = this.chart.getContext(), e = this, i = this._tooltipItems, te(t, {
						tooltip: e,
						tooltipItems: i,
						type: "tooltip"
					})));
				...
				getTitle(t, e) {
					const {
						callbacks: i
					} = e, s = mo(i, "beforeTitle", this, t), n = mo(i, "title", this, t), o = mo(i, "afterTitle", this, t);
					let a = [];
					return a = no(a, oo(s)), a = no(a, oo(n)), a = no(a, oo(o)), a
				}
				getBeforeBody(t, e) {
					return fo(mo(e.callbacks, "beforeBody", this, t))
				}
				getBody(t, e) {
					const {
						callbacks: i
					...
					return g(t, t => {
						const e = {
							...
							n = go(i, t);
						no(e.before, oo(mo(n, "beforeLabel", this, t))), no(e.lines, mo(n, "label", this, t)), no(e.after, oo(mo(n, "afterLabel", this, t))), s.push(e)
					}), s
				}
				getAfterBody(t, e) {
					return fo(mo(e.callbacks, "afterBody", this, t))
				}
				getFooter(t, e) {
					const {
						callbacks: i
					} = e, s = mo(i, "beforeFooter", this, t), n = mo(i, "footer", this, t), o = mo(i, "afterFooter", this, t);
					let a = [];
					return a = no(a, oo(s)), a = no(a, oo(n)), a = no(a, oo(o)), a
				}
				_createItems(t) {
					const e = this._active,
						...
						o = [];
					let a, r, l = [];
					for (a = 0, r = e.length; a < r; ++a) l.push(ao(this.chart, e[a]));
					return t.filter && (l = l.filter((e, s, n) => t.filter(e, s, n, i))), t.itemSort && (l = l.sort((e, s) => t.itemSort(e, s, i))), g(l, e => {
						const i = go(t.callbacks, e);
						s.push(mo(i, "labelColor", this, e)), n.push(mo(i, "labelPointStyle", this, e)), o.push(mo(i, "labelTextColor", this, e))
				...
				update(t, e) {
					...
					let n, o = [];
					if (s.length) {
						const t = so[i.position].call(this, s, this._eventPosition);
						o = this._createItems(i), this.title = this.getTitle(o, i), this.beforeBody = this.getBeforeBody(o, i), this.body = this.getBody(o, i), this.afterBody = this.getAfterBody(o, i), this.footer = this.getFooter(o, i);
						const e = this._size = ro(this, i),
							a = Object.assign({}, t, e),
							r = ho(this.chart, i, a),
							l = co(i, a, r, this.chart);
				...
				drawTitle(t, e, i) {
					...
					if (n) {
						...
						for (t.x = uo(this, i.titleAlign, i), e.textAlign = l.textAlign(i.titleAlign), e.textBaseline = "middle", o = Qt(i.titleFont), a = i.titleSpacing, e.fillStyle = i.titleColor, e.font = o.string, r = 0; r < n; ++r) e.fillText(s[r], l.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + a, r + 1 === n && (t.y += i.titleMarginBottom - a)
					}
				}
				_drawColorBox(t, e, i, s, n) {
					...
					if (n.usePointStyle) {
						const e = {
							...
							l = g + r / 2;
						t.strokeStyle = n.multiKeyBackground, t.fillStyle = n.multiKeyBackground, Et(t, e, i, l), t.strokeStyle = o.borderColor, t.fillStyle = o.backgroundColor, Et(t, e, i, l)
					} else {
						t.lineWidth = l(o.borderWidth) ? Math.max(...Object.values(o.borderWidth)) : o.borderWidth || 1, t.strokeStyle = o.borderColor, t.setLineDash(o.borderDash || []), t.lineDashOffset = o.borderDashOffset || 0;
						...
						Object.values(a).some(t => 0 !== t) ? (t.beginPath(), t.fillStyle = n.multiKeyBackground, jt(t, {
							...
							h: r - 2,
							radius: a
						}), t.fill()) : (t.fillStyle = n.multiKeyBackground, t.fillRect(e, g, h, r), t.strokeRect(e, g, h, r), t.fillStyle = o.backgroundColor, t.fillRect(i, g + 1, h - 2, r - 2))
					}
				...
				drawBody(t, e, i) {
					...
					let d = c.lineHeight,
						u = 0;
					const f = Fe(i.rtl, this.x, this.width),
						p = function (i) {
							e.fillText(i, f.x(t.x + u), t.y + d / 2), t.y += d + n
						},
						m = f.textAlign(o);
					let x, b, _, y, v, M, w;
					for (e.textAlign = o, e.textBaseline = "middle", e.font = c.string, t.x = uo(this, m, i), e.fillStyle = i.bodyColor, g(this.beforeBody, p), u = a && "right" !== m ? "center" === o ? l / 2 + h : l + 2 + h : 0, y = 0, M = s.length; y < M; ++y) {
						for (x = s[y], b = this.labelTextColors[y], e.fillStyle = b, g(x.before, p), _ = x.lines, a && _.length && (this._drawColorBox(e, t, y, f, i), d = Math.max(c.lineHeight, r)), v = 0, w = _.length; v < w; ++v) p(_[v]), d = c.lineHeight;
						g(x.after, p)
					}
					u = 0, d = c.lineHeight, g(this.afterBody, p), t.y -= n
				}
				drawFooter(t, e, i) {
					const s = this.footer,
						n = s.length;
					let o, a;
					if (n) {
						const r = Fe(i.rtl, this.x, this.width);
						for (t.x = uo(this, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = r.textAlign(i.footerAlign), e.textBaseline = "middle", o = Qt(i.footerFont), e.fillStyle = i.footerColor, e.font = o.string, a = 0; a < n; ++a) e.fillText(s[a], r.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + i.footerSpacing
					}
				}
				...
				_updateAnimationTarget(t) {
					const e = this.chart,
						...
						n = i && i.y;
					if (s || n) {
						const i = so[t.position].call(this, this._active, this._eventPosition);
						if (!i) return;
				...
				draw(t) {
					...
					const o = Jt(e.padding),
						a = this.title.length || this.beforeBody.length || this.body.length || this.afterBody.length || this.footer.length;
					e.enabled && a && (t.save(), t.globalAlpha = i, this.drawBackground(n, t, s, e), Ve(t, e.textDirection), n.y += o.top, this.drawTitle(n, t, e), this.drawBody(n, t, e), this.drawFooter(n, t, e), Be(t, e.textDirection), t.restore())
				}
				getActiveElements() {
					return this._active || []
				}
				...
				_positionChanged(t, e) {
					const {
						...
						caretY: s,
						options: n
					} = this, o = so[n.position].call(this, t, e);
			...
			function Mo(t, e) {
				...
				k = Math.ceil(m / S) - Math.floor(p / S), k > g && (S = B(k * S / g / f) * f), a(l) || (v = Math.pow(10, l), S = Math.ceil(S * v) / v), "ticks" === s ? (M = Math.floor(p / S) * S, w = Math.ceil(m / S) * S) : (M = p, w = m), x && b && n && function (t, e) {
					const i = Math.round(t);
					return i - e <= t && i + e >= t
				}((r - o) / n, S / 1e3) ? (k = Math.round(Math.min((r - o) / S, c)), S = (r - o) / k, M = o, w = r) : _ ? (M = x ? o : M, w = b ? r : w, k = h - 1, S = (w - M) / k) : (k = (w - M) / S, k = V(k, Math.round(k), S / 1e3) ? Math.round(k) : Math.ceil(k));
				const P = Math.max($(S), $(M));
				v = Math.pow(10, a(l) ? P : l), M = Math.round(M * v) / v, w = Math.round(w * v) / v;
				let D = 0;
				for (x && (u && M !== o ? (i.push({
						value: o
					}), M < o && D++, V(Math.round((M + D * S) * v) / v, o, wo(o, y, t)) && D++) : M < o && D++); D < k; ++D) {
				...
				return b && u && w !== r ? i.length && V(i[i.length - 1].value, r, wo(r, y, t)) ? i[i.length - 1].value = r : i.push({
					value: r
				}) : b && w !== r || i.push({
					value: w
				}), i
			...
			class ko extends ys {
				...
				buildTicks() {
					...
					return "ticks" === t.bounds && N(s, this, "value"), t.reverse ? (s.reverse(), this.start = this.max, this.end = this.min) : (this.start = this.min, this.end = this.max), s
				}
				configure() {
					const t = this.ticks;
					let e = this.min,
				...
				getLabelForValue(t) {
					return yt(t, this.chart.options.locale, this.options.ticks.format)
				}
			}
			class So extends ko {
				static id = "linear";
			...
			const Po = t => Math.floor(z(t)),
				Do = (t, e) => Math.pow(10, Po(t) + e);

			function Co(t) {
				return 1 === t / Math.pow(10, Po(t))
			}
			...
			function Ao(t, {
				...
				let o = function (t, e) {
						...
						for (; Oo(t, e, i) > 10;) i++;
						for (; Oo(t, e, i) < 10;) i--;
						return Math.min(i, Po(t))
					}(e, i),
					a = o < 0 ? Math.pow(10, Math.abs(o)) : 1;
				const r = Math.pow(10, o),
					l = n > o ? Math.pow(10, n) : 0,
					h = Math.round((e - l) * a) / a,
					d = Math.floor((e - l) / r / 10) * r * 10;
				let u = Math.floor((h - d) / Math.pow(10, o)),
					f = c(t.min, Math.round((l + d + u * Math.pow(10, o)) * a) / a);
				for (; f < i;) s.push({
					value: f,
					major: Co(f),
					significand: u
				}), u >= 10 ? u = u < 15 ? 15 : 20 : u++, u >= 20 && (o++, u = 2, a = o >= 0 ? 1 : a), f = Math.round((l + d + u * Math.pow(10, o)) * a) / a;
				const g = c(t.max, f);
				return s.push({
					value: g,
					major: Co(g),
			...
			class To extends ys {
				...
				determineDataLimits() {
					...
					this.min = h(t) ? Math.max(0, t) : null, this.max = h(e) ? Math.max(0, e) : null, this.options.beginAtZero && (this._zero = !0), this._zero && this.min !== this._suggestedMin && !h(this._userMin) && (this.min = t === Do(this.min, 0) ? Do(this.min, -1) : Do(this.min, 0)), this.handleTickRangeOptions()
				}
				handleTickRangeOptions() {
					const {
						minDefined: t,
					...
					const n = e => i = t ? i : e,
						o = t => s = e ? s : t;
					i === s && (i <= 0 ? (n(1), o(10)) : (n(Do(i, -1)), o(Do(s, 1)))), i <= 0 && n(Do(s, -1)), s <= 0 && o(Do(i, 1)), this.min = i, this.max = s
				}
				buildTicks() {
					const t = this.options,
						e = Ao({
					...
					return "ticks" === t.bounds && N(e, this, "value"), t.reverse ? (e.reverse(), this.start = this.max, this.end = this.min) : (this.start = this.min, this.end = this.max), e
				}
				getLabelForValue(t) {
					return void 0 === t ? "0" : yt(t, this.chart.options.locale, this.options.ticks.format)
				}
				configure() {
					const t = this.min;
			...
			function Lo(t) {
				...
				if (e.display && t.display) {
					const t = Jt(e.backdropPadding);
					return d(e.font && e.font.size, Ct.font.size) + t.height
				}
				return 0
			}
			...
			function Io(t) {
				const e = {
					...
					r = a.centerPointLabels ? C / o : 0;
				for (let l = 0; l < o; l++) {
					const o = a.setContext(t.getPointLabelContext(l));
					n[l] = o.padding;
					const h = t.getPointPosition(l, t.drawingArea + n[l], r),
						c = Qt(o.font),
						d = Eo(t.ctx, c, t._pointLabels[l]);
					s[l] = d;
					const u = q(t.getIndexAngle(l) + r),
						f = Math.round(j(u));
					zo(i, e, u, Ro(f, h.x, d.w, 0, 180), Ro(f, h.y, d.h, 90, 270))
				}
				t.setCenterPoint(e.l - i.l, i.r - e.r, e.t - i.t, i.b - e.b), t._pointLabelItems = function (t, e, i) {
					...
					for (let o = 0; o < n; o++) {
						...
						const n = Fo(t, o, l);
						s.push(n), "auto" === r && (n.visible = Vo(n, h), n.visible && (h = n))
					}
					return s
				}(t, s, n)
			}

			function zo(t, e, i, s, n) {
			...
			function Bo(t, e, i) {
				...
				if (!a(l)) {
					const i = Gt(e.borderRadius),
						a = Jt(e.backdropPadding);
					t.fillStyle = l;
					const h = s - a.left,
						c = n - a.top,
						d = o - s + a.width,
						u = r - n + a.height;
					Object.values(i).some(t => 0 !== t) ? (t.beginPath(), jt(t, {
						x: h,
						y: c,
						w: d,
						h: u,
			...
			class No extends ko {
				...
				setDimensions() {
					const t = this._padding = Jt(Lo(this.options) / 2),
				...
				generateTickLabels(t) {
					ko.prototype.generateTickLabels.call(this, t), this._pointLabels = this.getLabels().map((t, e) => {
				...
				fit() {
					const t = this.options;
					t.display && t.pointLabels.display ? Io(this) : this.setCenterPoint(0, 0, 0, 0)
				}
				...
				getIndexAngle(t) {
					return q(t * (O / (this._pointLabels.length || 1)) + H(this.options.startAngle || 0))
				}
				...
				drawBackground() {
					...
					if (t) {
						const i = this.ctx;
						i.save(), i.beginPath(), Wo(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length), i.closePath(), i.fillStyle = t, i.fill(), i.restore()
					}
				}
				drawGrid() {
					const t = this.ctx,
					...
					if (e.pointLabels.display && function (t, e) {
							...
							for (let n = e - 1; n >= 0; n--) {
								...
								Ht(i, t._pointLabels[n], r, l + a.lineHeight / 2, a, {
									color: o.color,
									textAlign: h,
									textBaseline: "middle"
								})
							...
							if (0 !== e || 0 === e && this.min < 0) {
								...
								! function (t, e, i, s, n) {
									...
									!a && !s || !r || !l || i < 0 || (o.save(), o.strokeStyle = r, o.lineWidth = l, o.setLineDash(n.dash || []), o.lineDashOffset = n.dashOffset, o.beginPath(), Wo(t, i, a, s), o.closePath(), o.stroke(), o.restore())
								}(this, a, r, o, l)
							}
						}), i.display) {
			...
			function Uo(t, e) {
				...
				let r = e;
				return "function" == typeof s && (r = s(r)), h(r) || (r = "string" == typeof s ? i.parse(r, s) : i.parse(r)), null === r ? null : (n && (r = "week" !== n || !W(o) && !0 !== o ? i.startOf(r, n) : i.startOf(r, "isoWeek", o)), +r)
			}

			function Yo(t, e, i, s) {
				const n = jo.length;
				for (let o = jo.indexOf(t); o < n - 1; ++o) {
					const t = Ho[jo[o]],
						n = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
					if (t.common && Math.ceil((i - e) / (n * t.size)) <= s) return jo[o]
				}
				return jo[n - 1]
			}
			...
			class Ko extends ys {
				...
				init(t, e = {}) {
					const i = t.time || (t.time = {}),
						s = this._adapter = new Pi(t.adapters.date);
					s.init(e), y(i.displayFormats, s.formats()), this._parseOpts = {
						parser: i.parser,
						round: i.round,
				...
				parse(t, e) {
					return void 0 === t ? null : Uo(this, t)
				}
				beforeLayout() {
				...
				determineDataLimits() {
					...
					o && a || (r(this._getLabelBounds()), "ticks" === t.bounds && "labels" === t.ticks.source || r(this.getMinMax(!1))), s = h(s) && !isNaN(s) ? s : +e.startOf(Date.now(), i), n = h(n) && !isNaN(n) ? n : +e.endOf(Date.now(), i) + 1, this.min = Math.min(s, n - 1), this.max = Math.max(s + 1, n)
				}
				_getLabelBounds() {
				...
				buildTicks() {
					...
					return this._unit = e.unit || (i.autoSkip ? Yo(e.minUnit, this.min, this.max, this._getLabelCapacity(n)) : function (t, e, i, s, n) {
						for (let o = jo.length - 1; o >= jo.indexOf(i); o--) {
							const i = jo[o];
							if (Ho[i].common && t._adapter.diff(n, s, i) >= e - 1) return i
						}
						return jo[i ? jo.indexOf(i) : 0]
					}(this, o.length, e.minUnit, this.min, this.max)), this._majorUnit = i.major.enabled && "year" !== this._unit ? function (t) {
						for (let e = jo.indexOf(t) + 1, i = jo.length; e < i; ++e)
							if (Ho[jo[e]].common) return jo[e]
					}(this._unit) : void 0, this.initOffsets(s), t.reverse && o.reverse(), qo(this, o, this._majorUnit)
				}
				afterAutoSkip() {
				...
				_generate() {
					const t = this._adapter,
						...
						s = this.options,
						n = s.time,
						o = n.unit || Yo(n.minUnit, e, i, this._getLabelCapacity(e)),
						a = d(s.ticks.stepSize, 1),
					...
					for (c = f, u = 0; c < i; c = +t.add(c, a, o), u++) Xo(h, c, g);
					return c !== i && "ticks" !== s.bounds && 1 !== u || Xo(h, c, g), Object.keys(h).sort($o).map(t => +t)
				}
				getLabelForValue(t) {
				...
				_getLabelCapacity(t) {
					const e = this.options.time,
						...
						n = this._tickFormatFunction(t, 0, qo(this, [t], this._majorUnit), s),
				...
				getLabelTimestamps() {
					...
					for (e = 0, i = s.length; e < i; ++e) t.push(Uo(this, s[e]));
			...
			var Jo = Object.freeze({
				__proto__: null,
				CategoryScale: class extends ys {
					static id = "category";
					static defaults = {
						ticks: {
							callback: vo
					...
					parse(t, e) {
						...
						return ((t, e) => null === t ? null : G(Math.round(t), 0, e))(e = isFinite(e) && i[e] === t ? e : yo(i, t, d(e, t), this._addedLabels), i.length - 1)
					}
					determineDataLimits() {
						const {
							minDefined: t,
				...
				TimeScale: Ko,
				TimeSeriesScale: class extends Ko {
					...
					initOffsets() {
						...
						this._minPos = Go(e, this.min), this._tableRange = Go(e, this.max) - this._minPos, super.initOffsets(t)
					}
					buildLookupTable(t) {
						const {
							min: e,
