                ...
                <main class="content">
                    ...
                    <section class="kpi-grid" aria-label="Ringkasan Keuangan">
                        ...
                        <article class="kpi-card c-primary">
                            ...
                            <div class="kpi-value">
                                Rp <?= number_format($ringkasan['saldo_atm'], 0, ',', '.'); ?>
                            </div>
                        ...
                        <article class="kpi-card c-success">
                            ...
                            <div class="kpi-value">
                                Rp <?= number_format($ringkasan['saldo_tunai'], 0, ',', '.'); ?>
                            </div>
                        ...
                        <article class="kpi-card c-danger">
                            ...
                            <div class="kpi-value">
                                Rp <?= number_format($ringkasan['pengeluaran_bulan_ini'], 0, ',', '.'); ?>
                            </div>
                        ...
                        <article class="kpi-card c-purple">
                            ...
                            <div class="kpi-value">
                                Rp <?= number_format($ringkasan['penarikan_bulan_ini'], 0, ',', '.'); ?>
                            </div>
                        ...
                        <article class="kpi-card c-primary">
                            ...
                            <div class="kpi-value">
                                Rp <?= number_format($ringkasan['saldo_awal_atm'], 0, ',', '.'); ?>
                            </div>

                            <div class="kpi-compare">
                                Awal Tunai:
                                <strong>
                                    Rp <?= number_format($ringkasan['saldo_awal_tunai'], 0, ',', '.'); ?>
                                </strong>
                            </div>
                        </article>
